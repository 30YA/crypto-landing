...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    dir="rtl"
    className={cn(
      'flex h-10 w-full items-center justify-between gap-2 rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm placeholder:text-gray-500 focus:outline-none focus:ring-1 focus:ring-gray-400 disabled:cursor-not-allowed disabled:opacity-50 dark:border-transparent dark:bg-black-1200 dark:ring-offset-gray-950 dark:placeholder:text-gray-400 dark:focus:ring-gray-600 [&>span]:line-clamp-1',
      className
    )}
    {...props}
  >
